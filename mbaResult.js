...
let db12 = new Dexie("mba")
    db12.version(1).stores({
        mba2: 'rollno, name, year,sem,  course1, course2, course3, course4, course5, course6'
    });
...
//================================================================================================================================================================================   
    var myTable = $('#tabledatamba2').DataTable({
        ...
        onAddRow: function(datatable, rowdata, success, error) {
            db12.mba2.add({rollno: rowdata[0], name: rowdata[1], year: rowdata[2], sem: rowdata[3], course1: rowdata[4], course2: rowdata[5], course3: rowdata[6], course4: rowdata[7], course5: rowdata[8], course6: rowdata[9]});
            success(rowdata);
            Notiflix.Notify.Success(rowdata[1]+' has been added');
        },
        onEditRow: function(datatable, rowdata, success, error) {
            db12.mba2.update(rowdata[0], {name: rowdata[1], year: rowdata[2], sem: rowdata[3], course1: rowdata[4], course2: rowdata[5], course3: rowdata[6], course4: rowdata[7], course5: rowdata[8], course6: rowdata[9]});
            success(rowdata);
    ...
    db12.mba2.toArray(dataMba2 => {
        if(dataMba2.length <= 0) {
            Notiflix.Confirm.Show(
